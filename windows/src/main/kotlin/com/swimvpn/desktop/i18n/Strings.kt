...
data class Strings(
    ...
    val autoConnectLabel: String, val autoConnectDesc: String,
...
private val FR = Strings(
    ...
    autostartDesc = "Lance SWIMVPN à l'ouverture de session (élevé, sans UAC)", startMinimizedLabel = "Démarrer minimisé",
    startMinimizedDesc = "Démarre dans la barre système, fenêtre masquée",
    autoConnectLabel = "Connexion auto au démarrage",
    autoConnectDesc = "Se connecte au dernier serveur dès le lancement de l'app",
...
private val EN = Strings(
    ...
    autostartDesc = "Launch SWIMVPN at sign-in (elevated, no UAC)", startMinimizedLabel = "Start minimized",
    startMinimizedDesc = "Start in the system tray, window hidden",
    autoConnectLabel = "Auto-connect on start",
    autoConnectDesc = "Connects to the last server as soon as the app launches",
...
private val RU = Strings(
    ...
    autostartDesc = "Запуск SWIMVPN при входе (с правами админа, без UAC)", startMinimizedLabel = "Запуск свёрнутым",
    startMinimizedDesc = "Запуск в системном трее, окно скрыто",
    autoConnectLabel = "Автоподключение при старте",
    autoConnectDesc = "Подключается к последнему серверу при запуске приложения",
