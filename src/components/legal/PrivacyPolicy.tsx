  ...
  return (
    <LegalLayout title="Privacy Policy">
      ...
      <section className="mb-10">
        <h2 className="text-2xl text-[#14130F] mb-4">1. Strict No-Logs Policy</h2>
      ...
      <section className="mb-10">
        <h2 className="text-2xl text-[#14130F] mb-4">2. Device Fingerprinting & Trial Management</h2>
        <p className="text-[#3F3C36] mb-4 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl text-[#14130F] mb-4">3. Freemium Autonomy</h2>
        <p className="text-[#3F3C36] leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl text-[#14130F] mb-4">4. Third-Party Services</h2>
        <p className="text-[#3F3C36] leading-relaxed">
