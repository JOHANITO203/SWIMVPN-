          ...
          <div className="grid gap-4 lg:grid-cols-5">
            <div className="rounded-[2rem] bg-[#07070B]/70 p-8 lg:col-span-3 md:p-12">
              ...
              <p className="mb-10 max-w-2xl text-lg leading-relaxed text-[#A6A1B3]">
                ...
                activer le trial depuis l’application et choisir entre achat in-app ou import gratuit de configs personnelles.
              </p>
              <motion.a
            ...
            <div className="grid gap-4 lg:col-span-2">
              ...
              <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-7">
                ...
                <p className="text-sm leading-relaxed text-[#A6A1B3]">Activez le trial dans l’app et consultez sa durée exacte avant d’acheter.</p>
              </div>
              <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-7">
