// Marque SWIMVPN (shark) — inline en currentColor → monochrome, réutilisée par la nav,
// le hero (badge) et le menu plein écran.
export default function CineLogo({ className }: { className?: string }) {
  return (
